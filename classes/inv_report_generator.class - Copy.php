...
FROM
	inv_item_sales 
	where sales_status='Not Pending' and sales_date between '$slfrom2' and '$slto2' and branch_id=$branch_id  and sales_type='1'";
	...
	$speci = "<table width=950 cellpadding=\"5\" cellspacing=\"0\" style='border-collapse:collapse'>
	            <tr>
	             <th nowrap=nowrap align=right style=\"border:#000000 solid 1px\">Total Quantity</th>
				 <th nowrap=nowrap align=right style=\"border:#000000 solid 1px\">Total Cost</th>
				 <th nowrap=nowrap align=right style=\"border:#000000 solid 1px\">Total Sales</th>
				 <th nowrap=nowrap align=right style=\"border:#000000 solid 1px\">Discount</th>
				 <th nowrap=nowrap align=right style=\"border:#000000 solid 1px\">Net Sales</th>
	       </tr>
		   <tr><td colspan='5' align='center'></td></tr>
		<tr><td colspan='5' align='left' height='30' style='border-top:#000000 solid 1px;border-left:#000000 solid 1px;border-right:#000000 solid 1px;' >
	...
	$TotalSales=(($TotalAmount)-($returnAmount+$netDisc));
	$profit=($TotalSales-$totalcostprice);
	$inPercnt=($profit/$totalcostprice)*100;
	
	$speci .= "<tr height=25 >
		<td align=right nowrap=nowrap style=\"border:#000000 solid 1px\"> <strong>".$totalQnt."</strong></td>
		...
		<td align=right nowrap=nowrap style=\"border:#000000 solid 1px\"><strong>".number_format($netDisc,2)."</strong></td>
		<td align=right nowrap=nowrap style=\"border:#000000 solid 1px\"><strong>".number_format($TotalSales,2)."</strong></td>
		</tr>
		<tr height=25 >
		<td align=right nowrap=nowrap style=\"border:#000000 solid 1px\" colspan=5> <strong>Total Profit : ".number_format($profit,2)." (".$inPercnt.")%</strong></td>
		</tr>
...
FROM
	inv_item_sales 
	where sales_status='Not Pending' and sales_date between '$slfrom2' and '$slto2' and branch_id=$branch_id and sales_type='2'";
	...
	$returnAmount2=$returnAmount2+$return_amount2;
	$TotalAmount2=$TotalAmount2+$total_amount2;
	$totalcostprice2 = $totalcostprice2+$totalCost2;
	$totalQnt2 = $totalQnt2+$item_qnt2;
	$netDisc2 = $netDisc2+$NwDisc2;
	...
	$TotalSales2=(($TotalAmount2)-($returnAmount2+$netDisc2));
	$profit2=($TotalSales2-$totalcostprice2);
	$inPercnt2=($profit2/$totalcostprice2)*100;
	...
	$netWholeSales=($TotalSales2-$dues_amount);
	
	$TotalSalesAmnt=($netWholeSales+$TotalSales);
	
	$speci .= "<tr height=25 >
		<td align=right nowrap=nowrap style=\"border:#000000 solid 1px\"> <strong>".$totalQnt2."</strong></td>
		<td align=right nowrap=nowrap style=\"border:#000000 solid 1px\"><strong>".number_format($totalcostprice2,2)."</strong></td>
		<td align=right nowrap=nowrap style=\"border:#000000 solid 1px\"><strong>".number_format($TotalAmount2,2)."</strong></td>
		<td align=right nowrap=nowrap style=\"border:#000000 solid 1px\"><strong>".number_format($netDisc2,2)."</strong></td>
		<td align=right nowrap=nowrap style=\"border:#000000 solid 1px\"><strong>".number_format($TotalSales2,2)."</strong></td>
		</tr>
		<tr height=25 >
		<td align=right nowrap=nowrap colspan=5> <strong>Total Profit : ".$profit2." (".$inPercnt2.")%</strong></td>
		</tr>
		<tr>
	  <td colspan='4' align='right'><strong>Whole Sales Received Amount : </strong></td>
	  <td  align='right'><strong>".number_format($netWholeSales,2)."</strong></td>
	  </tr>
	  <tr>
	  <td colspan='4' align='right'><strong> Whole Sales Dues Amount : </strong></td>
	  <td  align='right'><strong>".$dues_amount."</strong></td>
	  </tr>
	  
	  <tr>
	  <td colspan='5' align='left'><strong>Dues Received : </strong></td>
	  </tr>";
...
$speci .= "<tr height=25 >
		...
		<td nowrap=nowrap colspan=4 style=\"border:#000000 solid 1px\">".$rowDRes['store_name']."</td>
	...
	//$netDues=($totalDuesWhole-$totalduesRec);
	$speci .= "<tr>
		<td nowrap=nowrap colspan=4 style=\"border:#000000 solid 1px\" align=right><strong>Total : </strong></td>
		<td nowrap=nowrap style=\"border:#000000 solid 1px\" align=right><strong>".number_format($totalduesRec,2)."</strong></td>
		</tr>
	<tr>
	  <td colspan='4' align='right' style=\"border-top:#000000 solid 1px\"><strong>Total Sales(retail+whole) : </strong></td>
...
FROM
	...
	$crAmountInc=$rowInc['crAmount'];
		...
		<td nowrap=nowrap style=\"border:#000000 solid 1px\" colspan=3>".$account_nameInc."</td>
		<td nowrap=nowrap style=\"border:#000000 solid 1px\" align=right >".number_format($crAmountInc,2)."</td>
		</tr>";
...
FROM
	...
	$drAmount5=$row5['drAmount'];
		...
		<td nowrap=nowrap style=\"border:#000000 solid 1px\" colspan=3>".$account_name."</td>
		<td nowrap=nowrap style=\"border:#000000 solid 1px\" align=right>".number_format($drAmount5,2)."</td>
		</tr>";
	...
	$speci .= "<tr height=25 >
		...
		<tr height=25 >
		<td align=right nowrap=nowrap colspan=4><strong>Net Income : </strong></td>
