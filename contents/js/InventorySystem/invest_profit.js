...
/*----------------------------Update-------------------*/
function updateSupplierInfo(invest_id,holder_id,branch_id,main_item_category_id,invdate,profit)
	{
	...
	valid = true;
     if ( document.supplier_form.holder_id.value == ""   )
		...
		else if ( document.supplier_form.main_item_category_id.value == ""   )
        {
                ...
                valid = false;
        }else if ( document.supplier_form.profit.value == ""   )
        {
		        alert ( "profit Amount will not be empty!" );
				profit.focus();
                valid = false;
        }
